...
t.prompt.viewConfirm = "确认查看 ID 为 {id} 的数据吗？";
t.prompt.selectOne = "请选择一条数据";
t.validate = {};
...
t.tenant.select = "选择租户";
t.tenant.current = "默认租户";
t.tenant.datasource = "租户数据源";
t.tenant.domain = "租户域名";
t.tenant.domainTip = "通过域名区分租户时，为必填项";
t.tenant.driver = "驱动";
t.tenant.validate = {};
