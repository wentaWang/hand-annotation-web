...
t.prompt.viewConfirm = "Are you sure to view data with ID {id}?";
t.prompt.selectOne = "Please select one row";
t.validate = {};
...
t.tenant.current = "Default Tenant";
t.tenant.datasource = "DataSource";
t.tenant.domain = "Domain";
t.tenant.domainTip = "Required when distinguishing tenants by domain name";
t.tenant.driver = "Driver";
t.tenant.validate = {};
