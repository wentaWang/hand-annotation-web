    ...
    <el-scrollbar height="260px">
      <el-tabs type="border-card">
        <el-tab-pane>
          ...
          <div class="tabBody">
            <el-row>
              <el-radio v-model="second.cronEvery" value="1">{{ text.Seconds.every }}</el-radio>
            </el-row>
            <el-row>
              <el-radio v-model="second.cronEvery" value="2"
            ...
            <el-row>
              <el-radio v-model="second.cronEvery" class="long" value="3"
            ...
            <el-row>
              <el-radio v-model="second.cronEvery" value="4"
        ...
        <el-tab-pane>
          ...
          <div class="tabBody">
            <el-row>
              <el-radio v-model="minute.cronEvery" value="1">{{ text.Minutes.every }}</el-radio>
            </el-row>
            <el-row>
              <el-radio v-model="minute.cronEvery" value="2"
            ...
            <el-row>
              <el-radio v-model="minute.cronEvery" class="long" value="3"
            ...
            <el-row>
              <el-radio v-model="minute.cronEvery" value="4"
        ...
        <el-tab-pane>
          ...
          <div class="tabBody">
            <el-row>
              <el-radio v-model="hour.cronEvery" value="1">{{ text.Hours.every }}</el-radio>
            </el-row>
            <el-row>
              <el-radio v-model="hour.cronEvery" value="2"
            ...
            <el-row>
              <el-radio v-model="hour.cronEvery" class="long" value="3"
                >{{ text.Hours.specific }}
            ...
            <el-row>
              <el-radio v-model="hour.cronEvery" value="4"
                >{{ text.Hours.cycle[0] }}
        ...
        <el-tab-pane>
          ...
          <div class="tabBody">
            <el-row>
              <el-radio v-model="day.cronEvery" value="1">{{ text.Day.every }}</el-radio>
            </el-row>
            <el-row>
              <el-radio v-model="day.cronEvery" value="2"
